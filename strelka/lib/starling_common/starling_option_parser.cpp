...
write_starling_legacy_options(std::ostream& os) {
    ...
    os << 
        ...
        "                    - Don't use base if mismatch count>n within a window of m flanking bases. (see doc)\n"
        ...
        " -print-extra-snp-info\n"
        "                    - Append extra fields to snp call lines required for gVCF conversion\n"
        "\n"
